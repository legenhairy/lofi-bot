...
const songs = [
    {
        name: 'purrple-cat-green-tea',
        displayName: 'Green Tea',
        artist: 'Purrple Cat'
    },
    {
        name: 'rexlambo-close-your-eyes',
        displayName: 'close your eyes',
        artist: 'Rexlambo'
    },
    {
        name: 'kaleido-alone-with-my-thoughts',
        displayName: 'alone with my thoughts',
        artist: 'kaleido'
    }, 
    {
        name: 'purrple-cat-midnight-snack',
...
function updateProgressBar(e) {
    if (isPlaying) {
        ...
        if (durationSeconds) {
         ...
         // Calculate display for current time in song
